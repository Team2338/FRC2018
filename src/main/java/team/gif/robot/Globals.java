...
public class Globals {
    ...
    public static class Drivetrain {
        ...
        // Path Following
        public static final double DRIVE_P = 0.0; // P: 1.0
    ...
    public static class Arm {
        ...
        public static final int ARM_UPPER_SOFT_LIMIT = 550000;
        public static final int ARM_OPEN_SOFT_LIMIT = 302000;
        public static final int ARM_LOWER_SOFT_LIMIT = -45000;
        public static final int ARM_START_POSITION = 447000;
        ...
        public static final int ARM_POT_ZERO_POSITION = 657; // C = 390; P = 657;
    }
